...
namespace Casino.AdminPortal.Shared
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public AdminPortalValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, AdminPortalValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(AdminPortalValidationResult validationResult)
        {
